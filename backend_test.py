...
class NeoChefAPITester:
    def __init__(self, base_url="https://restaurant-preview-6.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Target URL: https://restaurant-preview-6.preview.emergentagent.com")
