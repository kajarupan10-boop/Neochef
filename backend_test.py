...
class NeoChefAPITester:
    def __init__(self, base_url="https://staff-permissions-v2.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Target URL: https://staff-permissions-v2.preview.emergentagent.com")
