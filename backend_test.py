...
class NeoChefAPITester:
    def __init__(self, base_url="https://chef-permissions-fix.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Target URL: https://chef-permissions-fix.preview.emergentagent.com")
